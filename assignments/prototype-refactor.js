...
class Hero extends Humanoid {
  ...
  stabs() {
    ...
    if (hit < 5) {
      ...
      console.log(
        `The Archor hit the Swordsman and scored ${deathPoints} points of damage, the Swordsman has ${swordsman.healthPoints} health points left`
      );
      if (swordsman.healthPoints < 1) {
  ...
  slashes() {
    ...
    if (hit < 5) {
      ...
      swordsman.healthPoints -= deathPoints;
      console.log(
        `The Mage hit the Swordsman and scored ${deathPoints} points of damage, the Swordsman has ${swordsman.healthPoints} health points left`
      );
      if (swordsman.healthPoints < 1) {
        return `The Swordsman is dead!`;
      } else {
